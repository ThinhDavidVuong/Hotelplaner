...
<div>
    ...
    <div class="left">
        ...
        <div class="checkbox">
            <label><input type="checkbox" value="Frühstuck" id="frühstück">Frühstück</label>
        </div>
        <div class="checkbox">
            <label><input type="checkbox" value="Mittag" id="mittag">Mittag</label>
        </div>
        <div class="checkbox">
            <label><input type="checkbox" value="Nachmittag" id="nachmittag">Nachmittag</label>
        </div>
        <div class="checkbox">
            <label><input type="checkbox" value="Abends" id="abends">Abends</label>
        </div>
    </div>
